...
- (instancetype)initWithParams:(NSDictionary *)params {
    if (self = [super initWithNibName:nil bundle:nil]) {
        // todo
        if (![self isKindOfClass:[CourseManagerViewController class]] && ![self isKindOfClass:[MineViewController class]] && ![self isKindOfClass:[TeachMaterialViewController class]] && ![self isKindOfClass:[GroupListViewController class]]) {
